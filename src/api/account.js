...
// 获取所有生成的充值地址
export const getUserRechageAddressAll = () =>
  post(`/api/recharge/getAdress`)
// 获取充值地址
...
// 提交充值
export const rechargeSubmit = (params,loading) => post('/api/recharge/submit', params,loading)
// 查询充值记录
...
// 银行卡对应币种汇率
export const getWithdrawMt5Amount = (params) => post(`/api/common/getWithdrawMt5Amount?coin=${params}`,)
// 提交提现
...
//   )
export const withdrawSubmit = (params,data,loading) => post(`/api/withdraw/submit?${params}`,data,loading)
export const withdrawSubmit2 = (params) => post(`/api/withdraw/submit`,params)
// 查询提现记录
...
export const updateUserAddress = (params) =>
  ...
  export const updatePaySubmit = (params,loading) =>
    post(
      `/api/top/pay/submit`,params,loading
    )
