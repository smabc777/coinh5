...
export const getPlatFormConfigApi = () => {
  return axios({
    url: `${location.origin}/platform/${__config._APP_ENV}/config.js?${+new Date()}`,
    method: 'get'
  })
}
/**
 ...
 * 获取首页轮播，滚动通知
 */
export const getHomeNotice = () => post('api/notice/getAllNoticeList')
 ...
 * @returns 客服列表
 */
export const getCustomerService = (data) => post(`/api/common/getCustomerService?userIds=${data || null}`)
