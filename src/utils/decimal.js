...
export const _toPrecision = (a, b) => {
  ...
  return Decimal(a).toPrecision(b, Decimal.ROUND_DOWN)
}
/**
 * 保留*位数
 */
...
export const _formattedAmount = (totalAmountFixed) => {
  let parseIntNum = parseInt(totalAmountFixed)
  // console.log(nnn, '1111');
  return parseFloat(parseIntNum).toLocaleString('en-US'
    // , {
    //   minimumFractionDigits: 2, // 最少小数位数
    //   maximumFractionDigits: 2 // 最多小数位数
    // }
  )
}
