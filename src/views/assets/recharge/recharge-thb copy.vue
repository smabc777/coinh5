...
/* const eur = [
  'EUR\n' +
    'Account name：HK DINGHUA TRADING LIMITED\n' +
    'IBAN：DK8689000023663393\n' +
    'SWIFT：SXPYDKKK\n' +
    'Bank area：Denmark (EU SEPA)\n' +
...
const gbp = [
  'GBP\n' +
    'Account name：HK DINGHUA TRADING LIMITED\n' +
    'Account number：00531154\n' +
    'IBAN: GB80MODR04008500531154\n' +
    'Sort code：040085\n' +
    'SWIFT：MODRGB21\n' +
    'Bank area：United Kingdom\n' +
    'Bank name：MODULR FS LIMITED\n' +
    'Bank address：58 Wood Ln, London, UK, W12 7RZ'
]
const usd = [
  'USD\n' +
    'Account name：HK DINGHUA TRADING LIMITED\n' +
    'Account number：8456287356\n' +
    'ACH：026073150\n' +
    'Routing Number：026073008\n' +
    'SWIFT：CMFGUS33\n' +
    'Bank area：United States\n' +
    'Bank name：COMMUNITY FEDERAL SAVINGS BANK\n' +
    'Bank address：89-16 Jamaica Ave, Woodhaven, NY, USA, 11421'
] */
// EUR1额外添加
const wireTransferList = {
  EUR1:
    'EUR\n' +
    'Account Name: CZECH LIMITED\n' +
    'IBAN：GB56TCCL00997982978261\n' +
    'SWIFT: TCCLGB31XXX\n' +
    'Bank area: United Kingdom\n' +
    'Bank Name: THE CURRENCY CLOUD LIMITED\n' +
    'Bank Address: FLOOR 0, THE STEWARD BUILDING, 12 STEWARD STREET, LONDON UK, E1 6FQ',
  EUR:
    'EUR\n' +
    'Account name: HK DINGHUA TRADING LIMITED\n' +
    'IBAN: DK8689000023663393\n' +
...
const wireTransferListIndex = ref(-1)
const bankinfodialog = (binfo, index) => {
  wireTransferListIndex.value = index
  showDialog({
    title: _showName('Bank_card_number'), // 银行信息
    confirmButtonText: _showName('copy'),
    message: wireTransferList[binfo]
  }).then(() => {
    _copy(wireTransferList[binfo])
  })
}
...
const submit = debounce(() => {
  ...
  let params = {
    money: priceFormat(num.value),
    type: route.query.type,
    coin: route.query.coin,
    filePath: filePath || '',
    cardNo: address.value,
  ...
  console.log(params)
  updatePaySubmit(params,{loading:true}).then((res) => {
    if (res.code == '200') {
