    ...
    >
      <div class="item" v-for="(item, index) in list" :key="index">
        ...
        <div class="everyItem">
          ...
          <div class="itemRight fw-num">{{ item.totleAmount }} USDC</div>
        </div>
      </div>
    </van-list>
...
const getInit = async () => {
  try {
    ...
    //   isAsc:'desc'
    // }
    const data = `userId=${userStore.userInfo.user?.userId}&pageNum=${pageNum.value}&pageSize=${pageSize.value}&orderByColumn=createTime&isAsc=desc&coin=usdc`
