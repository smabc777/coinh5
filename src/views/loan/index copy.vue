...
const cuttentRight = {
  iconRight: [
    { iconName: 'right-rule', clickTo: '/loan-rule' },
    { iconName: 'sub-record', clickTo: '/loan-record' }
  ]
}
  ...
  <div class="content">
    ...
    <div class="loan-detail">
      ...
      <div class="item">
        ...
        <!-- 到期一次还本息 -->
        <div class="right">
          <span v-if="['aug','mngx'].includes(_getConfig('_APP_ENV'))">
    ...
    <div class="bottom">
      ...
      <!-- 确认上传 -->
      <ButtonBar class="btn"  :btnValue="_t18('loan_require')" @click="submit"></ButtonBar>
...
.van-cell {
  height: 46px;
  background: var(--ex-input-bgcolor);
  border-radius: 3px;
  padding: 0 10px;
  font-size: 14px;
  display: flex;
...
.content {
  ...
  .loan-detail {
    margin-top: 30px;
    border-top: 1px solid var(--ex-box-border-color-deep);
    border-bottom: 1px solid var(--ex-box-border-color-deep);
