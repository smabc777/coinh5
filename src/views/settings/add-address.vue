...
<template>
  <div class="bg">
    <HeaderBar :currentName="_t18('bind_address')"></HeaderBar>
    <div class="form">
      <div class="form-item">
        <div class="label">
          <!-- 请选择链 -->
      ...
      <div class="form-item">
        ...
        <div class="input">
          ...
          /> -->
          <input :placeholder="_t18('exchange.input')" v-model="form.address" class="input-field" />
          <div class="tip Paste" @click="getPaste">
            <!-- 粘贴 -->
            {{ _t18('pasta') }}
          </div>
        </div>
    ...
    <van-action-sheet v-if="coinList.length" v-model:show="coinSheet" :actions="coinList" @select="onSelect"
...
:deep(.nav--bar) {
  background: var(--ex-default-bgcolor) !important;
