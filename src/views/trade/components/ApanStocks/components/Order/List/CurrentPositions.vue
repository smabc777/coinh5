...
const getSecondTabs = () => {
  ...
  console.log(headerSecondList.value,'headerSecondListheaderSecondList');
...
console.log(headerSecondList.value,'......,,')
...
async function closingPositionFn(item) {
    ...
    const data = await stockSell(obj, { loading: true })
