<template>
  <div>
    ...
    <HeaderBar
      :currentName="
        notPwd ? _t18('Change_security_password',['vitc']) : _t18('sidebar_tardPwd', ['bitmake'])
      "
    ...
    >
      <template #btn>
        <div class="btnBox" @click="changePwd">
          <ButtonBar :btnValue="_t18('Change_security_password',['vitc'])" />
        </div>
        <div class="forgot" @click="toCustorm">{{ _t18('forgot_security_code', ['vitc']) }}?</div>
      </template>
    </Success>
  </div>
</template>
...
<script setup>
import Success from '@/views/settings/components/Success.vue'
